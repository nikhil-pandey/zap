...
async def test_performance_large_repo(large_repo):
    ...
    )  # Assuming it should use less than 500 MB of additional memory
...
async def test_performance_very_large_repo(very_large_repo):
    ...
    )  # Assuming it should use less than 2 GB of additional memory
...
async def test_performance_multiple_analyses(large_repo):
    ...
    )  # Assuming it should use less than 1 GB of additional memory
